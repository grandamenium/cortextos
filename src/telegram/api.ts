/**
 * @deprecated Telegram code has moved to `src/connectors/telegram/api.ts`
 ...
 * after. Update imports to `../connectors/telegram/api.js` to silence the
 * deprecation when it lands.
 */
