 ...
 * matching the canonical EDITH gitleaks rule. Origin: 2026-05-06
 * baseline drift caught 27 hf_ token instances persisted to boss agent
 * logs (1 inbound-messages.jsonl + 26 stdout.log) — patched in-place
 * via sed and added here so future leaks redact at the PTY layer
 * instead of needing another scrub pass.
 */
