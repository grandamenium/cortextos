  ...
  apps: [
    {
      ...
      script: "/Users/phillipthomas/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/phillipthomas/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/phillipthomas/.cortextos/default",
    ...
    },
    {
      ...
      script: 'npm',
      args: 'run dev',
      cwd: "/Users/phillipthomas/cortextos/dashboard",
      env: {
