  ...
  apps: [
    {
      ...
      script: "/Users/robert/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/robert/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/robert/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/robert/cortextos",
        CTX_PROJECT_ROOT: "/Users/robert/cortextos",
        CTX_ORG: process.env.CTX_ORG || "click-to-acquire",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: 'npm',
      args: 'run dev',
      cwd: "/Users/robert/cortextos/dashboard",
      env: {
