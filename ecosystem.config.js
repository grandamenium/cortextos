  ...
  apps: [
    {
      ...
      script: "/Users/samersabbagh/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/samersabbagh/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/samersabbagh/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/samersabbagh/cortextos",
        CTX_PROJECT_ROOT: "/Users/samersabbagh/cortextos",
        CTX_ORG: process.env.CTX_ORG || "nyro-ct",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "/Users/samersabbagh/cortextos/dashboard",
      env: {
