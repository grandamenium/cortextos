  ...
  apps: [
    {
      ...
      script: "/Users/zelda/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/zelda/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/zelda/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/zelda/cortextos",
        CTX_PROJECT_ROOT: "/Users/zelda/cortextos",
        CTX_ORG: process.env.CTX_ORG || "zeusbot",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run start",
      cwd: "/Users/zelda/cortextos/dashboard",
      env: {
