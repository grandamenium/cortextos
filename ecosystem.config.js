  ...
  apps: [
    {
      ...
      script: "/Users/nightsage/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/nightsage/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/nightsage/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/nightsage/cortextos",
        CTX_PROJECT_ROOT: "/Users/nightsage/cortextos",
        CTX_ORG: process.env.CTX_ORG || "riles-fleet",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "start",
      cwd: "/Users/nightsage/cortextos/dashboard",
      env: {
